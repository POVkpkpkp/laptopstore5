...
export default function Nav() {
  ...
  return (
    <>
      {/* --------lg-screen----- */}
      <nav className="hidden w-full h-[70px] shadow-md lg:flex fixed top-0 left-0 z-50 bg-[#7aa6a3]">
        ...
        <div className="w-[40%] h-full flex justify-center">
          ...
          <div className="w-[40%] h-full flex justify-evenly items-center p-2 px-3">
            ...
            <a href="/login"><FaUser size={40} className="h-[50%] w-[50%]"/></a>
            <CartSlide />
          </div>
        </div>
      </nav>
      ...
      {/* --------md & sm screen----- */}
      <div className="lg:hidden w-full h-[60px] flex fixed top-0 left-0 z-50 bg-white shadow-md">
